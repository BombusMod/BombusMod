...
public class UserKey extends IconTextElement {
    ...
    private void initSomeKeyNames() { // TODO: подумать как и когда обнулять
        ...
        // Цифровые клавишы
        addKeyName(VirtualList.KEY_NUM0, "(0)");
        addKeyName(VirtualList.KEY_NUM1, "(1)");
        addKeyName(VirtualList.KEY_NUM2, "(2)");
        addKeyName(VirtualList.KEY_NUM3, "(3)");
        addKeyName(VirtualList.KEY_NUM4, "(4)");
        addKeyName(VirtualList.KEY_NUM5, "(5)");
        addKeyName(VirtualList.KEY_NUM6, "(6)");
        addKeyName(VirtualList.KEY_NUM7, "(7)");
        addKeyName(VirtualList.KEY_NUM8, "(8)");
        addKeyName(VirtualList.KEY_NUM9, "(9)");
        addKeyName(VirtualList.KEY_STAR, "*");
        addKeyName(VirtualList.KEY_POUND, "#");
        ...
        // Game Action
        Canvas display = (Canvas) Client.StaticData.getInstance().roster;
        addKeyName(display.getKeyCode(VirtualList.LEFT), "(<)");
        addKeyName(display.getKeyCode(VirtualList.RIGHT), "(>)");
        addKeyName(display.getKeyCode(VirtualList.UP), "(^)");
        addKeyName(display.getKeyCode(VirtualList.DOWN), "(V)");
        addKeyName(display.getKeyCode(VirtualList.FIRE), "(o)");
        addKeyName(display.getKeyCode(VirtualList.GAME_A), "Game_A");
        addKeyName(display.getKeyCode(VirtualList.GAME_B), "Game_B");
        addKeyName(display.getKeyCode(VirtualList.GAME_C), "Game_C");
        addKeyName(display.getKeyCode(VirtualList.GAME_D), "Game_D");
        display = null;
    }
