...
//#endif
	...
	if (!doReconnect) {
        ...
        try {
            ...
            theStream.setJabberListener( new RosterListener(this) );
...
//#ifdef JUICK
//#             Juick.juickContacts.removeAllElements();
//#             Juick.indexMainJuickContact = -1;
//#endif
