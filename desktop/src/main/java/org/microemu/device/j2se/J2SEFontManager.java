...
{
	private static String FACE_SYSTEM_NAME = "Segoe UI";
	private static String FACE_MONOSPACE_NAME = "Consolas";
	private static String FACE_PROPORTIONAL_NAME = "Segoe UI";
	...
	org.microemu.device.impl.Font getFont(Font meFont)
	{
	    ...
	    if (result == null) {
	    	...
	    	result = new J2SESystemFont(name, style, size);
